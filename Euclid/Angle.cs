...
namespace Euclid {
    ...
    public class Angle : IComparable {
        ...
        /// </summary>
        /// <param name = "r">the Range to normalize over</param>
        public void Normalize(Range r) {
            range = r;
            Normalize();
        }
        ...
        public Angle Subtract(Angle angle) {
            Angle result = null;
            if (angle != null) {
                if (angle.AngleRange != AngleRange) {
                    angle = new Angle(angle) {AngleRange = AngleRange};
                    angle.Normalize();
                }
                result = new Angle(radians - angle.radians, Unit.Radians, range);
                result.Normalize();
            }
            return result;
        }
        ...
        public Angle GetDeviationFromLinearity() {
            ...
            var this1 = new Angle(this) {AngleRange = Range.Signed};
            Angle result;
        ...
        public override string ToString() {
            return radians + " (radians) " + AngleRange;
        }
