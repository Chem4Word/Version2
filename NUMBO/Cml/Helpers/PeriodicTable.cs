...
namespace Numbo.Cml.Helpers
{
    public static class PeriodicTable
    {
        ...
        /// </summary>
        /// <param name="element"></param>
        /// <returns>-99 for non-selected elements</returns>
        public static int GetMinChargeWhenBonded(Element element)
        {
            int charge = -9;
            switch (element)
            {
        ...
        /// <param name="element"></param>
        /// <returns>-99 for non-selected elements</returns>
        public static int GetMaxChargeWhenBonded(Element element)
        {
            int charge = -99;
            switch (element)
            {
        ...
        /// <param name="element"></param>
        /// <returns>-99 for non-selected elements</returns>
        public static int GetMinCharge(Element element)
        {
            int charge = -9;
            switch (element)
            {
        ...
        /// <param name="element"></param>
        /// <returns>-99 for non-selected elements</returns>
        public static int GetMaxCharge(Element element)
        {
            int charge = -99;
            switch (element)
            {
        ...
        /// <param name="element"></param>
        /// <returns>-1 for non-selected elements</returns>
        public static int GetMinCoordinationNumber(Element element)
        {
            int coordinationNumber = -1;
            switch (element)
            {
                case (Element.H):
        ...
        /// <param name="element"></param>
        /// <returns>99 for non-selected elements</returns>
        public static int GetMaxCoordinationNumber(Element element)
        {
            int coordinationNumber = -1;
            switch (element)
            {
        ...
        /// <param name="element"></param>
        /// <returns>99 for non-selected elements</returns>
        public static int GetMaxAllowedLigandBondOrder(Element element)
        {
            int maxBondOrder = 99;
            switch (element)
            {
        ...
        /// <param name="element"></param>
        /// <returns>-1 for non-selected elements</returns>
        public static int GetMinValenceElectronCount(Element element)
        {
            int electronCount = -1;
            switch (element)
            {
        ...
        /// <summary>
        /// GET maximum valence electronc count
        /// only for selected elements
        /// H, B, C, Si, Ge, N, P, As, O, S, Se, F, Cl, Br, I,
        /// </summary>
        /// <param name="element"></param>
        /// <returns>18 for non-selected elements</returns>
        public static int GetMaxValenceElectronCount(Element element)
        {
            int electronCount = -1;
            switch (element)
            {
