...
namespace Chem4Word.UI.Molecules
{
    public static class Benzene
    {
        ...
        public static Run GenerateRun()
        {
            ...
            Wp.Extent extent1 = new Wp.Extent() { Cx = 348996L, Cy = 400050L };
            ...
            A.Extents extents1 = new A.Extents() { Cx = 348996L, Cy = 400050L };
            A.ChildOffset childOffset1 = new A.ChildOffset() { X = 0L, Y = 0L };
            A.ChildExtents childExtents1 = new A.ChildExtents() { Cx = 348996L, Cy = 400050L };
            ...
            A.Offset offset2 = new A.Offset() { X = 9525L, Y = 9525L };
            A.Extents extents2 = new A.Extents() { Cx = 164973L, Cy = 95250L };
            ...
            A.Path path1 = new A.Path() { Width = 164973L, Height = 95250L };

            A.MoveTo moveTo1 = new A.MoveTo();
            A.Point point1 = new A.Point() { X = "164973", Y = "0" };

            moveTo1.Append(point1);

            A.LineTo lineTo1 = new A.LineTo();
            A.Point point2 = new A.Point() { X = "0", Y = "95250" };
            ...
            A.Offset offset3 = new A.Offset() { X = 9525L, Y = 295275L };
            ...
            A.Offset offset4 = new A.Offset() { X = 339471L, Y = 104775L };
            ...
            A.Offset offset5 = new A.Offset() { X = 9525L, Y = 104775L };
            ...
            A.Offset offset6 = new A.Offset() { X = 34925L, Y = 130175L };
            ...
            A.Offset offset7 = new A.Offset() { X = 174498L, Y = 295275L };
            ...
            A.Offset offset8 = new A.Offset() { X = 183795L, Y = 285978L };
            ...
            A.Offset offset9 = new A.Offset() { X = 174498L, Y = 9525L };
            A.Extents extents9 = new A.Extents() { Cx = 164973L, Cy = 95250L };
            ...
            A.Path path8 = new A.Path() { Width = 164973L, Height = 95250L };
            ...
            A.Point point16 = new A.Point() { X = "164973", Y = "95250" };
            ...
            A.Offset offset10 = new A.Offset() { X = 183795L, Y = 44222L };
            A.Extents extents10 = new A.Extents() { Cx = 120979L, Cy = 69849L };
            ...
            A.Path path9 = new A.Path() { Width = 120979L, Height = 69849L };
            ...
            A.Point point18 = new A.Point() { X = "120979", Y = "69849" };
